...
--********************************************************************--
--author:qiuzhen1125
--create time:2024-11-25 16:29:49
--********************************************************************--
...
;
SELECT DISTINCT ds FROM user_click_brand_seq_feature WHERE ds>='20130401' AND ds<='20131001'; 
...
SELECT * from user_click_brand_seq_feature WHERE ds>='20130701' AND ds<='20131001' LIMIT 100;