...
--create time:2024-11-07 15:00:16
--********************************************************************--
...
where t2.item_num_90d is not null or t3.item_num_90d is not null or t4.item_num_90d is not null or t5.item_num_90d is not null
;

SHOW PARTITIONS user_pay_sample_feature_join;
SELECT * FROM user_pay_sample_feature_join WHERE ds='20130701' LIMIT 100;
...
SELECT COUNT(DISTINCT user_id) FROM user_pay_sample_feature_join WHERE ds>='20130701' AND ds<='20130916';