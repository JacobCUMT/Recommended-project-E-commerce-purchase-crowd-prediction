--@exclude_input=tmall_rec_project.user_pay_sample_feature_join
--odps sql 
--********************************************************************--
--author:qiuzhen1125
--create time:2024-11-26 09:59:41
--********************************************************************--
...
;
SELECT * FROM user_pay_sample_feature_seq LIMIT 100;
...
;
SELECT * FROM user_pay_sample_feature_join_dnn_seq LIMIT 100;
select count(*) from user_pay_sample_feature_join_dnn_seq;
SELECT distinct bizdate FROM user_pay_sample_feature_join_dnn_seq WHERE bizdate>='20130701' AND bizdate<='20131001';
...
;
SELECT * FROM user_pay_sample_feature_join_dnn_seq_shuffle LIMIT 100;
