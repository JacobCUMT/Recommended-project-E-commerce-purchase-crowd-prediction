--@exclude_input=tmall_rec_project.user_pay_cate_seq_feature
--@exclude_input=tmall_rec_project.user_clt_cate_seq_feature
--@exclude_input=tmall_rec_project.user_click_cate_seq_feature
--@exclude_input=tmall_rec_project.user_clt_brand_seq_feature
--@exclude_input=tmall_rec_project.user_pay_brand_seq_feature
--@exclude_input=tmall_rec_project.user_click_brand_seq_feature
--odps sql 
--********************************************************************--
--author:qiuzhen1125
--create time:2024-11-26 08:40:46
--********************************************************************--
...
SELECT * FROM user_pay_sample_feature_join_dnn WHERE ds>='20130701' AND ds<='20131001' LIMIT 100;
SELECT distinct ds FROM user_pay_sample_feature_join_dnn WHERE ds>='20130701' AND ds<='20131001' LIMIT 100;