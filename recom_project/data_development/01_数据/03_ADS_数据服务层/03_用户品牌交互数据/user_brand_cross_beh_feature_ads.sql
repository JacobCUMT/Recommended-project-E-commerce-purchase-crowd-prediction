...
SHOW PARTITIONS user_brand_cross_beh_feature_ads;
SELECT * FROM user_brand_cross_beh_feature_ads  WHERE ds='${bizdate}' LIMIT 100;

SELECT count(*) FROM user_brand_cross_beh_feature_ads WHERE ds='${bizdate}';