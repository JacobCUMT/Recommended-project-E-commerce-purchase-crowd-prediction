...
--********************************************************************--
--author:qiuzhen1125
--create time:2024-11-27 09:08:56
--********************************************************************--
...
;
select * from user_pay_sample_feature_join_dnn_eval where ds=${bizdate} limit 1000;
...
select t1.brand_id as keys_all, t1.label, t1.number,
...
SELECT count(distinct target_brand_id) FROM user_pay_sample_feature_join_eval_dnn_seq;